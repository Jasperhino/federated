...
from optimization.tasks import emnist_cvae
...
_SUPPORTED_TASKS = [
    'cifar100', 'emnist_cr', 'emnist_ae', 'emnist_cvae', 'shakespeare', 'stackoverflow_nwp',
    'stackoverflow_tp'
]
...
def _configure_managers() -> Tuple[tff.simulation.FileCheckpointManager, List[tff.simulation.MetricsManager]]:
...
def main(argv):
    ...
    elif FLAGS.task == 'emnist_cvae':
        runner_spec = emnist_cvae.configure_training(task_spec)
